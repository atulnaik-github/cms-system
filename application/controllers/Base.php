...
class Base extends CI_Controller {
	...
	public function __construct(){
		...
		// if (!empty($this->session->sessiondata['userid'])) {
		// 	$para = array('email' => $this->session->sessiondata['username'],'status' => 'logout');
		//     $this->$GETLASTLOGIN = $this->op->getLastLoginTime($para,$this->TBLLOGINLOGS);
		// } else {
		// 	# code...
		// }
